...
CPPFLAGS :=-Iinclude -I../libraries/SocketServer/include -I/opt/vc/include -MMD -MP
...
LDLIBS :=-lssl -ldl -lcrypto -lrgbmatrix -lm -lpthread -lrt -lbrcmEGL -lbrcmGLESv2 -lGLESv2 -lstdc++fs
