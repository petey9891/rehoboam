...
void Clock::run() {
    ...
    strftime(dateBuffer, sizeof(dateBuffer), dateFormat.c_str(), &tm);
    
    rgb_matrix::DrawText(this->canvas, this->font, 0, this->heightOffset + this->font.baseline(), rgb_matrix::Color(255, 255, 255), nullptr, dateBuffer, 0);
    rgb_matrix::DrawText(this->canvas, this->font, 0, this->heightOffset + this->font.baseline() * 2, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    rgb_matrix::DrawText(this->canvas, this->font, 0, this->heightOffset + this->font.baseline() * 3, rgb_matrix::Color(255, 255, 255), nullptr, dateBuffer, 0);
