...
void Clock::run() {
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 0,  this->heightOffset + this->font.baseline(), rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    rgb_matrix::DrawText(this->canvas, this->font, 25, this->heightOffset + this->font.baseline() * 2, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 25, this->heightOffset + this->font.baseline() * 4, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 89, this->heightOffset + this->font.baseline() * 2, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 89, this->heightOffset + this->font.baseline() * 4, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 153, this->heightOffset + this->font.baseline() * 2, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 153, this->heightOffset + this->font.baseline() * 4, rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
