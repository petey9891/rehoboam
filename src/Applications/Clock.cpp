...
void Clock::run() {
    ...
    rgb_matrix::DrawText(this->canvas, this->font, 0, 128 + this->font.baseline(), rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    rgb_matrix::DrawText(this->canvas, this->font, 128, 0 + this->font.baseline(), rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
    rgb_matrix::DrawText(this->canvas, this->font, 200, 0 + this->font.baseline(), rgb_matrix::Color(255, 255, 255), nullptr, buffer, 0);
